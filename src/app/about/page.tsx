...
const About = () => {
  return (
    ...
    <div className="w-[525px] h-[336px] ml-[135px] mt-[322] text-justify">
    ...
    <div className=" w-[1170px] h-[230px] flex  ml-[135] gap-[30px] mt-[70px]">
    ...
    <div className=" w-[1170px] h-[564px] flex  ml-[135] gap-[30px] mt-[80px]">
